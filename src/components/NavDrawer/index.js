...
const NavDrawer = props => {
            ...
            <List disablePadding>
                {menuItems.map((item, index) => {
                    if (item.subMenuItems !== undefined) {
                        return (
                            < ListItem disableRipple className={classes.drawerListItem} button key={index} >
                                <ListItemText primary={item.name} />
                            </ListItem>
                        )
                    } else {
                        return (
                            <Link className={classes.drawerListItem} key={index} to={item.path}>
                                < ListItem disableRipple to={item.path} button  >
                                    <ListItemText primary={item.name} />
                                </ListItem>
                            </Link>
                        )
    ...
    return (
        <>
            ...
            >
                <div className={clsx(shrinkTrigger ? classes.drawerScrollMargin : classes.drawerMargin)} />
