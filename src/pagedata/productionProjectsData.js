...
const productionProjectsData = [
  ...
  },
  {
    ...
    image: surettaventer,
    text:
      "A portfolio website for photographers, it is built with React and Gatsby. It features React photo gallery, it is styled with Bootstrap 4. The site is hosted on an AWS S3 bucket with a CD pipeline controlled with AWS Pipeline.",
    github: undefined,
