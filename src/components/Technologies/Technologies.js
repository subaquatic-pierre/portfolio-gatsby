            ...
            <Grid data-test='component-Technologies-container' container justify='center' className={classes.content}>
                ...
                <Grid container item xs={12} sm={6}>
                    <Card className={classes.textCard}>
                        ...
                        <Typography>
                            <b>React</b> - React provides a powerful programing paradigm with the use of Javascript, markdown and styling all within a single module. <a href='https://testing-library.com/docs/dom-testing-library/intro'>React Testing Library</a> promotes excellent testing techniques with emphasis on avoiding implementation details when writing unit and integration tests. <a href='https://www.apollographql.com/docs/react/'>Apollo Client</a> provides an easy API for connecting to a GraphQL backend, the use of Apollo Server within a Node JS environment allows for seamless front-end to back-end integration.
                        </Typography>
                        <Typography>
                            <b>Django</b> - The all-in-one, "kitchen sink", of web development frameworks. Django is great for user management out of the box. With a few package installations such as <a href='https://django-allauth.readthedocs.io/en/latest/installation.html'>Django-all-auth</a> it can be setup with O-Auth which further extends user management with 3rd party authentication providers. There are many other well supported packages which easily allow for the extension of Django capabilities. <a href='https://docs.graphene-python.org/projects/django/en/latest/'>Graphene</a> extends Django's SQL schema to a GraphQL schema, making available through an API.
                        </Typography>
                        <Typography>
                            <b>Mongo DB</b> - A blob data storage solution which lends itself well to horizontal scalling. It is a great solution for the current climate of micro-services.
                        </Typography>
                        <Typography>
                        ...
                        <Typography>
                            <b>Linux</b> - The Linux terminal is a power-tool for programmers, allowing quick access to services. SSH provides quick remote access to external machines. Linux makes it easy to run database daemons for SQL and Non-SQL databases locally during development.
                        </Typography>
                    </Card>
                </Grid>
            </Grid>
