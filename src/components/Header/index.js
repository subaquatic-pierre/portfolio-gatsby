...
import { useScrollTrigger, useMediaQuery, useTheme, makeStyles } from '@material-ui/core'
import {
    AppBar,
    Toolbar,
...
import menuItems from '../../pagedata/headerMenuItems'
...
const Header = (props) => {
    ...
    const navBreakPoint = useMediaQuery(theme.breakpoints.up('md'))
    ...
    return (
        <>
            <AppBar color="primary" elevation={4} position="fixed" className={classes.appBar}>
                <Toolbar >
                    <Button
                        disableRipple
                        onClick={handleClick}
                        to='/'
                        className={clsx(classes.appBar, shrinkTrigger ? classes.logoShrink : classes.logo)} >
